...
function Footer() {
    ...
    useEffect(() => {
        getFeaturedCourses()
            ...
            .catch((err) => {
                console.error(
                    "Failed to fetch featured courses for footer:",
                    err
                );
            })
            .finally(() => {
            ...
            <div className="footer__container">
                ...
                <div className="footer__main">
                    ...
                    <div className="footer__column footer__contact">
                        ...
                        <a href="tel:+20224056479">
                           <span className="footer__contact-icon">
                              <Phone size={16} />
                           </span>
                            <span>02 24056479</span>
                        </a>

                        <a
                            href="https://wa.me/201065115607"
                            target="_blank"
                        ...
                        >
                          <span className="footer__contact-icon">
                            ...
                            <span>010 65115607</span>
                        </a>


                        <a href="mailto:info@mtccenters.com">
                          <span className="footer__contact-icon">
                            <Mail size={16} />
                          </span>
                            <span>info@mtccenters.com</span>
                        </a>
